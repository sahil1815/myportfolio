        ...
        <div className="h-full w-full max-w-xl mx-auto bg-gray-50 from-[#000000] border-[#1b2c68a0] relative rounded-lg border bg-gradient-to-r to-[#0a0d37] shadow-lg min-w-0 px-2 sm:px-0">
          ...
          <div className="overflow-hidden border-t-[2px] border-indigo-900 px-4 lg:px-8 py-4 lg:py-8 relative">
            ...
            <div className="relative flex">
              <div className="hidden md:flex flex-col items-end pr-4 text-gray-500 text-xs">
              ...
              <code className="font-mono text-xs md:text-sm lg:text-base w-full relative">
                <div>
                  ...
                  <span className="mr-2 font-mono text-pink-400">=</span>
                ...
                <div className="pl-6">
                  <span className="font-mono text-white">seniority: </span>
                  <span className="text-gray-500 font-mono">'</span>
                  <span className="font-mono text-green-400">
                    Junior
                  </span>
                ...
                <div className="pl-6">
                  <span className="font-mono text-white">skills: </span>
                  <span className="text-gray-500 font-mono">[</span>
